...
import com.learnnix.ClientSide.Admin.Views.V_AdminDashboard;
...
public class V_LoginStudent {
    private JFrame frame;

    public V_LoginStudent(){
        initiateFrame();
    }
    ...
    private void frameStyling(){
        JLabel welcomeLabel = new JLabel("Welcome! Login");
    ...
    private void loginListener(JPasswordField passwordField,JTextField emailField){
        if(passwordField.getText().equals("")||emailField.getText().equals("")){
            ...
            try {
                ...
                if(student.studentLogin(new StudentInfos(passwordField.getText(),emailField.getText()))) {
                    JOptionPane.showMessageDialog(frame, "Login Successful");
                    new V_StudentDashboard(student);
                    frame.dispose();
